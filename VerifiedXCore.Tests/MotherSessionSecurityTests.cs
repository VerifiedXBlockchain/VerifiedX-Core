...
namespace VerifiedXCore.Tests
{
    ...
    public class MotherSessionSecurityTests
    {
        ...
        public void ConnectionLifetime_ActiveConnection_IsNotCancelled()
        {
            ...
            VerifiedXCore.Globals.MothersKidsContext[testIP] = mockContext.Object;

            // Act - Verify the connection is considered active
            var existingContextInDict = VerifiedXCore.Globals.MothersKidsContext.TryGetValue(testIP, out var retrievedContext);
            ...
            // Cleanup
            VerifiedXCore.Globals.MothersKidsContext.TryRemove(testIP, out _);
        ...
        public void MothersKidsContext_EnforcesOneConnectionPerIP()
        {
            ...
            VerifiedXCore.Globals.MothersKidsContext[testIP] = mockContext1.Object;
            var firstContext = VerifiedXCore.Globals.MothersKidsContext[testIP];

            // Replace with second connection (simulating the replacement logic)
            VerifiedXCore.Globals.MothersKidsContext[testIP] = mockContext2.Object;
            var secondContext = VerifiedXCore.Globals.MothersKidsContext[testIP];
            ...
            Assert.Single(VerifiedXCore.Globals.MothersKidsContext.Where(kvp => kvp.Key == testIP));
        ...
        public void MothersKidsContext_DifferentIPs_AllowMultipleConnections()
        {
            ...
            VerifiedXCore.Globals.MothersKidsContext[testIP1] = mockContext1.Object;
            VerifiedXCore.Globals.MothersKidsContext[testIP2] = mockContext2.Object;

            // Assert - Both connections should coexist
            Assert.True(VerifiedXCore.Globals.MothersKidsContext.ContainsKey(testIP1));
            Assert.True(VerifiedXCore.Globals.MothersKidsContext.ContainsKey(testIP2));
            Assert.Equal("connection-1", VerifiedXCore.Globals.MothersKidsContext[testIP1].ConnectionId);
            Assert.Equal("connection-2", VerifiedXCore.Globals.MothersKidsContext[testIP2].ConnectionId);

            // Cleanup
            VerifiedXCore.Globals.MothersKidsContext.TryRemove(testIP1, out _);
            VerifiedXCore.Globals.MothersKidsContext.TryRemove(testIP2, out _);
        }
    }
}
