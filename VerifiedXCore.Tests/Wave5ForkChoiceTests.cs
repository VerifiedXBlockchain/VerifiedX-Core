...
using static VerifiedXCore.Utilities.ForkChoiceUtility;
...
namespace VerifiedXCore.Tests
{
    ...
    public class Wave5ForkChoiceTests
    {
        ...
        {
            var origEnforce = VerifiedXCore.Globals.CertEnforceHeight;
            try
            {
                VerifiedXCore.Globals.CertEnforceHeight = 1000;
            ...
            {
                VerifiedXCore.Globals.CertEnforceHeight = origEnforce;
            }
        }
    }
}
