...
using FrostBlacklist = VerifiedXCore.Bitcoin.Services.FrostContractBlacklist;
using System.Collections.Concurrent;
using System.Text;

namespace VerifiedXCore.Bitcoin.Controllers
{
    /// <summary>
    ...
    public class VBTCController : ControllerBase
    {
        ...
        private async Task ExecuteMPCCeremonyLocally(string ceremonyId, MPCCeremonyState ceremony)
        {
            ...
            List<VerifiedXCore.Bitcoin.Models.VBTCValidator> allValidators;
            try
            {
        ...
        public async Task<string> ExecuteCompleteWithdrawalRaw([FromBody] ExecuteCompleteWithdrawalRawPayload payload)
        {
            try
            {
                ...
                var preSignedAuth = new VerifiedXCore.Bitcoin.FROST.Models.PreSignedLeaderAuth
                {
