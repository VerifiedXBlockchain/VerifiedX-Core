...
namespace ReserveBlockCore.Privacy
{
    ...
    /// </summary>
    /// <remarks>
    /// Amount fields use little-endian <see cref="ulong"/> scaled by <see cref="Globals.PrivacyAmountScalingFactor"/> (10^8),
    /// via <see cref="PrivacyPedersenAmount.TryToScaledU64"/>. That matches the current Pedersen FFI and VFX's 8 decimal
    /// places, supporting amounts up to ~184 billion VFX within <c>u64</c>.
    /// </remarks>
